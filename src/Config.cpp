...
Config::Config() :
    ...
    renderPath(Cluster::RenderPath::ClusteredDeferred),
    ...
    customScene(false),
    useLightsFromScene(false),
    measureOverSeconds(-1),
    lights(1),
    maxLights(262144),
    tilePixelSizeX(16),
    tilePixelSizeY(16),
    backbufferResolutionX(3840),
    backbufferResolutionY(2160),
    treatClusterXYasPixelSize(false),
    clustersX(16),
    clustersY(8),
    clustersZ(24),
